# DataAI ETL for InterSystems IRIS â€” Customer-Ready Evaluation
...
- [Customer-ready evaluation ZIP](downloads/DataAI_ETL_IRIS_Evaluation.zip)
- [SHA-256 sidecar](downloads/DataAI_ETL_IRIS_Evaluation.zip.sha256)
...
Extract the package, review LICENSE.md, and use an isolated IRIS namespace. Run the local DataAI Spark smoke test, execute smoke-test\iris-live\setup-evaluation.sql, and then run the live IRIS smoke test with a customer-supplied compatible InterSystems JDBC driver. Require DATAAI_IRIS_SMOKE_TEST_PASS.
...
InterSystems IRIS function-output and integration documentation is included in `docs/`.
...
docs/
  ...
  FUNCTION_OUTPUTS_FOR_IRIS.html
  README_IRIS.html
  usage.css
```
